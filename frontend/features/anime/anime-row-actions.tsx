  ...
  return (
    <>
      <div className="flex flex-nowrap items-center justify-end gap-1.5">
        <ActionButton asChild emoji="✏️" label="Edit">
          <Link
        ...
        <ActionButton
          ...
          onClick={() => {
            if (requireOwnerAction()) updateDownloaded.mutate({ id: anime.id, downloaded: !anime.downloaded });
          }}
        ...
        <ActionButton
          ...
          label={watchingLabel}
          onClick={() => {
            if (requireOwnerAction()) updateStatus.mutate({ id: anime.id, status: watchingStatus });
          }}
        ...
        <ActionButton
          ...
          onClick={() => {
            if (requireOwnerAction()) updateStatus.mutate({ id: anime.id, status: completedStatus });
          }}
          disabled={updateStatus.isPending}
        />
        <ActionButton
          ...
          label="Delete"
          onClick={() => {
            if (requireOwnerAction()) deleteAnime.mutate(anime.id);
          }}
